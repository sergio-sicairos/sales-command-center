...
export async function GET(request) {
  try {
    ...
    // Get all opportunities attributed to this SDR (no filters)
    const allOpps = await soql(`
      SELECT Owner.Name, Name, StageName, CreatedDate, LeadSource, SDR_Points__c,
             ...
             Manual_Override_SDR_Attributable__c, Manual_Override_SDR_Attributable__r.Name, Type
      FROM Opportunity
      WHERE Owner.Name = '${sdrName}'
