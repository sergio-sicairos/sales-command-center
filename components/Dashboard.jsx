      ...
      <div className="dc" style={isTV ? { width: "1440px", minHeight: "1020px", transform: `scale(${tvScale})`, transformOrigin: "top center", flexShrink: 0 } : {}}>
        ...
        {!loading && !error && data && tab === "ae" && (
          <div style={{ display: "flex", gap: isTV ? 12 : 16, marginBottom: isTV ? 16 : 28, alignItems: "stretch" }}>
            <div style={{ width: isTV ? 220 : 240, backgroundImage: "linear-gradient(180deg, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.4) 40%, rgba(0,0,0,0.8) 100%), url('/costa-rica.jpg')", backgroundSize: "cover", backgroundPosition: "center", border: "2px solid #f97316", borderRadius: 14, padding: isTV ? "12px 14px" : "16px 18px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 6, flexShrink: 0, boxShadow: "0 4px 14px rgba(249,115,22,0.25)" }}>
