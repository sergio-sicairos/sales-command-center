...
const QUOTES = [
  ...
  { text: "Why do we fall, sir? So that we can learn to pick ourselves up.", author: "Alfred, Batman Begins" },
  ...
  { text: "You've got a friend in me.", author: "Woody, Toy Story" },
  ...
  { text: "Oh yes, the past can hurt. But you can either run from it, or learn from it.", author: "Rafiki, The Lion King" },
  { text: "Remember who you are.", author: "Mufasa, The Lion King" },
  { text: "Hakuna Matata.", author: "Timon & Pumbaa, The Lion King" },
  ...
  { text: "Not all those who wander are lost.", author: "Bilbo Baggins, The Fellowship of the Ring" },
  ...
  { text: "Run, Forrest, run!", author: "Jenny, Forrest Gump" },
  { text: "It ain't about how hard you hit. It's about how hard you can get hit and keep moving forward.", author: "Rocky Balboa" },
  { text: "Going the distance.", author: "Rocky" },
  { text: "Carpe diem. Seize the day, boys. Make your lives extraordinary.", author: "John Keating, Dead Poets Society" },
  { text: "O Captain! My Captain!", author: "Dead Poets Society" },
  ...
  { text: "Hold onto your butts.", author: "Ray Arnold, Jurassic Park" },
  { text: "I feel the need... the need for speed!", author: "Maverick & Goose, Top Gun" },
  { text: "Here's looking at you, kid.", author: "Rick Blaine, Casablanca" },
  { text: "We'll always have Paris.", author: "Rick Blaine, Casablanca" },
  { text: "Frankly, my dear, I don't give a damn.", author: "Rhett Butler, Gone with the Wind" },
  { text: "After all, tomorrow is another day!", author: "Scarlett O'Hara, Gone with the Wind" },
  { text: "I'm king of the world!", author: "Jack Dawson, Titanic" },
  { text: "Never let go.", author: "Rose, Titanic" },
  { text: "Just when I thought I was out, they pull me back in.", author: "Michael Corleone, The Godfather Part III" },
  ...
  { text: "There's no crying in baseball!", author: "Jimmy Dugan, A League of Their Own" },
  ...
  { text: "I had the time of my life.", author: "Dirty Dancing" },
  { text: "You can't handle the truth!", author: "Col. Jessup, A Few Good Men" },
  { text: "Every man dies. Not every man really lives.", author: "William Wallace, Braveheart" },
  { text: "They may take our lives, but they'll never take our freedom!", author: "William Wallace, Braveheart" },
  ...
  { text: "I love you 3000.", author: "Morgan Stark, Avengers: Endgame" },
  { text: "Wakanda forever!", author: "Black Panther" },
  { text: "Higher, further, faster.", author: "Captain Marvel" },
  ...
  { text: "We are Groot.", author: "Groot, Guardians of the Galaxy" },
  { text: "There's no place like home.", author: "Dorothy, The Wizard of Oz" },
  ...
  { text: "I see you.", author: "Avatar" },
  { text: "As you wish.", author: "Westley, The Princess Bride" },
  { text: "My name is Inigo Montoya.", author: "Inigo Montoya, The Princess Bride" },
  { text: "Inconceivable!", author: "Vizzini, The Princess Bride" },
  { text: "Have fun storming the castle!", author: "Miracle Max, The Princess Bride" },
  { text: "Death cannot stop true love. All it can do is delay it for a while.", author: "Westley, The Princess Bride" },
  { text: "Stay gold, Ponyboy. Stay gold.", author: "Johnny, The Outsiders" },
  ...
  { text: "Pay it forward.", author: "Pay It Forward" },
  ...
  { text: "We accept the love we think we deserve.", author: "Mr. Anderson, The Perks of Being a Wallflower" },
  { text: "In this moment, I swear, we are infinite.", author: "Charlie, The Perks of Being a Wallflower" },
  { text: "Today, we celebrate our Independence Day!", author: "President Whitmore, Independence Day" },
  { text: "I am Spartacus!", author: "Spartacus" },
  { text: "Every great dream begins with a dreamer.", author: "Glory" },
  { text: "Open your eyes.", author: "Vanilla Sky" },
  { text: "Roads? Where we're going we don't need roads.", author: "Doc Brown, Back to the Future" },
  ...
  { text: "There's no place I'd rather be than right here, right now.", author: "Hugh Jackman, The Greatest Showman" },
  { text: "No matter what they tell you, no matter what they say, you are who you choose to be.", author: "The Iron Giant" },
  { text: "Souls cannot be destroyed. Souls grow into something else.", author: "Soul" },
  ...
  { text: "When life gets you down, do you wanna know what you've gotta do? Just keep swimming.", author: "Dory, Finding Nemo" },
