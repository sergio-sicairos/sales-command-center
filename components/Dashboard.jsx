                    ...
                    <div className="tv-card" key={ae.name}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: "#64748b", marginTop: 8 }}>
                        ...
                        {(() => {
                          ...
                          return (
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 10px", background: "#1e293b", borderRadius: 6, border: "1.5px solid #334155", marginTop: 4 }}><span style={{ fontWeight: 600, color: "#cbd5e1" }}>Expected Land:</span><div style={{ display: "flex", alignItems: "baseline", gap: 6 }}><span style={{ fontWeight: 800, color: "#fff", fontSize: 15 }}>{fmt(ae.closed + ae.commit)}</span><span style={{ fontWeight: 700, color: expectedLandColor, fontSize: 12 }}>{expectedLandAtt}%</span></div></div>
                          );
                        })()}
                      </div>
