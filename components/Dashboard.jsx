                  ...
                  return (
                    <div className="tv-card" key={ae.name}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 4, fontSize: 12, color: "#64748b", marginTop: 8 }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 10px", background: "linear-gradient(135deg, #0284c7 0%, #0369a1 100%)", borderRadius: 6, border: "1.5px solid #0161a3", marginTop: 4 }}><span style={{ fontWeight: 600, color: "#fff" }}>Expected Land:</span><div style={{ display: "flex", alignItems: "baseline", gap: 6 }}><span style={{ fontWeight: 800, color: "#fff", fontSize: 15 }}>{fmt(ae.closed + ae.commit)}</span><span style={{ fontWeight: 600, color: "#e0f2fe", fontSize: 12 }}>{q > 0 ? Math.round(((ae.closed + ae.commit) / q) * 100) : (ae.closed + ae.commit > 0 ? 100 : 0)}%</span></div></div>
                      </div>
