...
const AVATARS = {
  ...
  "Eve Thorsen": "/avatars/eve-thorson.jpeg",
...
const QUOTES = [
  ...
  { text: "Oh yes, the past can hurt. But the way I see it, you can either run from it or learn from it.", author: "Rafiki, The Lion King" },
  ...
  { text: "I am Iron Man.", author: "Tony Stark, Avengers" },
  { text: "The night is darkest just before the dawn.", author: "Harvey Dent, The Dark Knight" },
  { text: "Every day is a gift. That's why they call it the present.", author: "Bil Keane" },
  ...
  { text: "It is our choices that show what we truly are, far more than our abilities.", author: "Albus Dumbledore, Harry Potter" },
  ...
  { text: "It does not do to dwell on dreams and forget to live.", author: "Albus Dumbledore, Harry Potter" },
  ...
  { text: "Even the smallest person can change the course of the future.", author: "Galadriel, Lord of the Rings" },
  { text: "There is some good in this world, and it's worth fighting for.", author: "Samwise Gamgee, Lord of the Rings" },
  { text: "All we have to decide is what to do with the time that is given us.", author: "Gandalf, Lord of the Rings" },
  ...
  { text: "The stuff of dreams is made of this.", author: "Prospero, The Tempest" },
  { text: "To thine own self be true.", author: "Polonius, Hamlet" },
